        ...
        private void makeShitUp(object sender, EventArgs e)
        {
            try
            {
                ...
                for (int i = 1; i <= 10; i++) // Loop 10 times to create 10 fake movies.
                {
                    ...
                    movie.tumbnail = theaterDataManager.convertImageToBas64String(@"C:\Users\River\source\repos\DeveloperSpoot\CS161_FinalProject_MovieTheaterManager\MovieThumbnails\taylor-swift-the-eras-tour-movie-poster.png"); // Setting our thumbnail that string we creating.
